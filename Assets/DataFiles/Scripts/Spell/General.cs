...
public class General : MonoBehaviour
{
    ...
    IEnumerator GenerateFireBall()
    {
        ...
        /*        if (_testing)
                {
                    _g = Instantiate(_fireBall[_indexSpell], _spawnPoint.transform.position, _spawnPoint.transform.rotation, _spawnPoint.transform);
                }
                else if(!_testing)
                {
                    _g = Instantiate(_fireBall[UnityEngine.Random.Range(0, 5)], _spawnPoint.transform.position, _spawnPoint.transform.rotation, _spawnPoint.transform);
                }*/

        _g = Instantiate(_fireBall[UnityEngine.Random.Range(0, _fireBall.Length)], _spawnPoint.transform.position, _spawnPoint.transform.rotation, _spawnPoint.transform);
    ...
    private void Shoot()
    {
        ...
        _carshoot.SetThrust(_rb.velocity.z);
        if (_carshoot)
        {
            _carshoot.Fire();
        }
